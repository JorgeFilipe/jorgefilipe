### Hi there :smirk:
  ...
  In my free time I like to play video games (:video_game:), watch movies(:movie_camera:) and series(:tv:) and do a beautiful guitar solo (:guitar:), or play that blues on the drums(:trumpet:).
